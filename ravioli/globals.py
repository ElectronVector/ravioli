...
def extract_declarations_from_statement(statement):
    ...
    for i, t in enumerate(tokens):
        if t == ",":
            ...
            # yet. If we have previously saved a declaration, append it to our list.
            if potential_declaration:
                declarations.append(potential_declaration)
                potential_declaration = None
            ...
            # Save the last valid identifier because this is could be the declaration (if it's actually the last one.
            potential_declaration = t
